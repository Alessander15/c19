...
mainCyclist.setCollider("rectangle",0,0,1320,1320);
...
function draw() {
  ...
  if (World.frameCount % 150 == 0) {
   ...
   if(pinkCG.isTouching(mainCyclist)){
    ...
    text("Pressione a Seta Para Cima para Reiniciar o jogo!",450,200);
    path.velocityX = 0;
...
function pinkCyclists(){
        ...
        pinkCG.add(player1);
        //player1.debug=true;
        player1.setCollider("rectangle",0,0,1350,1350);    
...
function yellowCyclists(){
       ...
       // player2.debug=true;
        player2.setCollider("rectangle",0,0,1350,1350);
}
...
function redCyclists(){
        ...
        redCG.add(player3);
       // player3.debug=true;
        player3.setCollider("rectangle",0,0,1350,1350);
}
